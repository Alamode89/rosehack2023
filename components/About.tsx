  ...
  return (
    <div className="bg-gradient-to-b from-about-top to-about-bottom w-full flex justify-center items-center flex-col">
      ...
      <div className="flex justify-between items-center w-2/3 p-5">
        <div className="w-2/3 p-5">
          <div className="flex justify-between items-center mb-4">
            <img src="PINK_HEART1.png" className="h-10 w-10 drop-shadow-pink" />
            <FaCircle className="text-white drop-shadow-pink" />
            <img src="PINK_HEART1.png" className="h-10 w-10 drop-shadow-pink" />
            <FaCircle className="text-white drop-shadow-pink" />
            <img src="PINK_HEART1.png" className="h-10 w-10 drop-shadow-pink" />
          </div>
      ...
      <div className="flex justify-between items-center w-2/3 p-5">
        ...
        <div className="w-2/3 p-5">
          <div className="flex justify-between items-center mb-4">
            <img src="BLUE_HEART1.png" className="h-10 w-10 drop-shadow-blue" />
            <FaCircle className="text-white drop-shadow-blue" />
            <img src="BLUE_HEART1.png" className="h-10 w-10 drop-shadow-blue" />
            <FaCircle className="text-white drop-shadow-blue" />
            <img src="BLUE_HEART1.png" className="h-10 w-10 drop-shadow-blue" />
          </div>
      ...
      <div className="bg-gradient-to-r from-about-left to-about-right w-1/2 rounded-3xl m-5 drop-shadow-white">
