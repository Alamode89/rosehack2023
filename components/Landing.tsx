  ...
  return (
    <div className="flex flex-col bg-gradient-to-br from-landing-bottom to-landing-bottompink w-full justify-center item-center pt-10">
      ...
      <div className="relative m-auto bg-gradient-to-b from-landing-secondtop/50 to-landing-second-bottom/20 rounded-3xl text-center justify-center items-center md:w-7/12 w-10/12 p-4">
        ...
        <div className="drop-shadow-lightblue text-white font-pixel text-2xl md:text-4xl justify-center m-3">
        Rose Hack <br /> 2023
          <div className="absolute inset-0  w-full animate-glitch  text-[#f0f] font-pixel text-2xl md:text-4xl justify-center">
            Rose Hack <br /> 2023
          </div>
          <div className="absolute inset-0 w-full  animate-glitchReverse  text-[#0ff] font-pixel text-2xl md:text-4xl justify-center">
            Rose Hack <br /> 2023
          </div>
          <div className="absolute inset-0 w-full drop-shadow-lightblue text-white font-pixel text-2xl md:text-4xl justify-center">
            Rose Hack <br /> 2023
          </div>
        </div>
        <p className="animate-shinging pt-3 text-lg md:text-2xl no-underline drop-shadow-lightblue text-white font-pixel">
          {" "}
          JANUARY 14-15
        </p>
