...
const QA = [
  ...
  },
  {
    ...
    answer:
      "Of course not! You will be allowed to attend workshops, listen to some wonderful speakers, and best of all, win great prizes. And fine, we won’t stop you if your other reason for attending will be for the free food and swag that is provided.",
  },
  {
