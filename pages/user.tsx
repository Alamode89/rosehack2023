  ...
  return (
    <div className="flex justify-center items-center flex-col bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-400 w-full min-h-screen">
      <div className="flex flex-col justify-center items-center h-11/12 w-1/4 bg-white rounded-lg">
        <p className="h-12 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 font-pixel  text-md md:text-xl lg:text-2xl text-center m-4">
          Login
        </p>
        <label className="text-left font-pixel text-md text-gray-700 w-10/12">
          email
        </label>
        <input
          type="text"
        ...
        <div className="flex flex-row w-10/12 items-center justify-start mt-4">
          <label className="text-left font-pixel text-md text-gray-700 mr-2">
            password
          </label>
          {visible ? (
            <FaEye
              className="text-2xl text-gray-500 hover:cursor-pointer hover:text-blue-400"
